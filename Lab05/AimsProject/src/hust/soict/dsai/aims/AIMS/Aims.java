...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            switch (option) {
                case 0:
                    exit = true;
                    System.out.println("Thank you and good bye ^3^ !!!");
                    break;
                case 1:
                    clearConsole();
                    storeMenu(scanner);
    ...
    public static void initSetup() {
        ...
        Book book = new Book("The Valley of Fear", "Detective", 21.00f);
        Book book1 = new Book("A Living Remedy: A Memoir", "Biography", 212.00f);
        Book book2 = new Book("On the Origin of Time: Stephen Hawking's Final Theory", "Science", 140.00f);
        store.addMedia(book);
        store.addMedia(book1);
        store.addMedia(book2);


        CompactDisc cd1 = new CompactDisc("Adele", "Music","Adele", 1500.00f);
        Track track1CD1 = new Track("All Night Parking", 162);
        Track track2CD1 = new Track("Loved", 401);
        Track track3CD1 = new Track("The Men", 302);
        ...
        Track track1CD2 = new Track("Everything", 180+34);
        Track track2CD2 = new Track("Blood", 180+30);
